...
function lsx_blocks_plugin_cgb_block_assets() { // phpcs:ignore
	...
	wp_register_script(
		'lsx_blocks_plugin-cgb-block-js', // Handle.
	...
	wp_register_style(
		'lsx_blocks_plugin-cgb-block-editor-css', // Handle.
	...
	register_block_type(
		'cgb/block-lsx-blocks-plugin', array(
			...
			'editor_script' => 'lsx_blocks_plugin-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'lsx_blocks_plugin-cgb-block-editor-css',
		)
	);
}
